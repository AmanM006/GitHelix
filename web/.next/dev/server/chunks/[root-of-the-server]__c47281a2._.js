...
const authOptions = {
    ...
    callbacks: {
        ...
        async session ({ session, token }) {
            // Pass the token to the session so the frontend/API can see it
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-route] (ecmascript)"); // Import from the new lib file
;
;
;
;
async function POST(req) {
    ...
    try {
        ...
        // Call Python
        const pythonResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post("http://127.0.0.1:8000/scan", {
            repo_name: repo_full_name,
            access_token: session.accessToken
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(pythonResponse.data);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c47281a2._.js.map